...
class WCSCL_Utils {
	...
	// 	$result = update_option(WOOCFCL_PREFIX.'_' . $key, $fields);
	// 	return $result;
	// }

	// public static function get_fields($key){
	// 	$fields = get_option(WOOCFCL_PREFIX.'_'. $key, array());
	...
	// 	$order_id = false;
	// 	if(WOOCFCL_Utils::woo_version_check()){
