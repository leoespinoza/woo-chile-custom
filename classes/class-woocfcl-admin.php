...
if (!class_exists('WOOCFCL_Admin')):
    ...
    class WOOCFCL_Admin
	{
        ...
        private $current_option_datatable= array();
		...
		public function enqueue_styles_and_scripts($hook)
		{
			...
			wp_enqueue_style('materializeicon-style-admin', '//fonts.googleapis.com/icon?family=Material+Icons', array('jquery-ui-style'), false, 'all');
		...
		public function set_admin_ui()
		{
            ...
            $this->get_current_option_datatable();

            $config=array('view'=>$this->currentSection, 'lang'=>WOOCFCL()->langlocale);
            wp_localize_script( 'woocfcl-script-admin', 'woocfcl_config', $config);
    		wp_localize_script( 'woocfcl-script-admin', 'woocfcl_countries', WOOCFCL()->app->option_datatable);
            wp_localize_script( 'woocfcl-script-admin', 'woocfcl_options', $this->current_option_datatable);
		...
		private function get_current_nav()
		{
            $this->currentMessage = '';
		...
		private function get_current_option_datatable()
		{
			$this->current_option_datatable = WOOCFCL()->get_option_datatable($this->currentSection);
			return $this->current_option_datatable;
		}
