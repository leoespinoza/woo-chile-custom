...
class WCSCL_Admin {
	...
	public function enqueue_styles_and_scripts($hook) {
		...
		if(strpos($hook, 'page_woo_chile_designer') === false) {
			return;
		}
		...
		wp_enqueue_style('wcscl-admin-style', WCSCL_ASSETS_URL . 'css/wcscl-admin.css', WOOCFCL_VERSION);
		wp_enqueue_script('wcscl-admin-script', WCSCL_ASSETS_URL . 'js/wcscl-admin.js', $deps, WOOCFCL_VERSION, true);
	}
                	...
                	<tr>
                        ...
                        <td>
                        	<a target="_blank" href="https://www.themehigh.com/product/woocommerce-checkout-field-editor-pro/">
                            	<img src="<?php echo WCSCL_ASSETS_URL ?>css/upgrade-btn.png" />
                            </a>
                        </td>
                    </tr>
                </table>
